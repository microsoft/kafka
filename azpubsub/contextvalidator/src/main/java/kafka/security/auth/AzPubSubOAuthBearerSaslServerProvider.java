...
import azpubsub.contextvalidator.kafka.security.auth.AzPubSubOAuthBearerSaslServer;

import java.security.Provider;
import java.security.Security;

public class AzPubSubOAuthBearerSaslServerProvider extends Provider {
    ...
    public static void initialize() {
        Security.addProvider(new AzPubSubOAuthBearerSaslServerProvider());
    }
}
